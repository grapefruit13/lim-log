...
description: '나도 모르게 사용하고 있는 플래그 인수들을 찾아서 제거해보자'
categories: ['리팩터링', '플래그 인수', 'flag argument']
thumbnail: 'https://sprint-fe-project.s3.ap-northeast-2.amazonaws.com/globalnomad/profile_image/2-3_116_1722420292152.avif'
