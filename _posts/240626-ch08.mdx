...
description: '반복문을 더 간결하고 직관적인 코드로 바꿀 수 있는 방법'
categories: ['리팩터링', '컬렉션_파이프라인', 'Collection_Pipeline', 'filter', 'map']
thumbnail: "https://sprint-fe-project.s3.ap-northeast-2.amazonaws.com/globalnomad/profile_image/2-3_116_1720775325500.avif"
