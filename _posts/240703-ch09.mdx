...
description: '이미 사용 중인 레코드 필드의 이름을 바꾸고 싶을 때 이렇게 해보자'
categories: ['리팩터링']
thumbnail: 'https://sprint-fe-project.s3.ap-northeast-2.amazonaws.com/globalnomad/profile_image/2-3_116_1720775282413.avif'
