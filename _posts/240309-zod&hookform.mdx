...
description: '함께 쓰면 최고의 조합인 zod와 hook form'
categories: ['zod', 'react-hook-form', 'validation']
thumbnail: "https://sprint-fe-project.s3.ap-northeast-2.amazonaws.com/globalnomad/profile_image/2-3_116_1720775428547.avif"
...
<a href='https://github.com/sprint-team3/GGF'>GGF 프로젝트</a>에서는 `react hook form`과 `zod`를 함께 사용해 유저의 입력값 유효성 검사를 진행했었습니다.
...
<img src='https://sprint-fe-project.s3.ap-northeast-2.amazonaws.com/globalnomad/profile_image/2-3_116_1720581423390.png' alt='ggf login page'/>
...
<a href='https://react-hook-form.com/docs/useform/register'>register validation 옵션들 알아보기</a>
...
<a href='https://github.com/TickyTocky/TickyTocky'>TickyTokcy 프로젝트</a>에서 사용해본 결과, 다음과 같은 아쉬움들을 느꼈습니다.
...
<a href='https://github.com/sprint-team3/GGF'>GGF</a>와 <a href='https://github.com/TickyTocky/TickyTocky'>TickyTokcy</a> 깃헙에서 확인해보실 수 있습니다.
...
- <a href='https://www.react-hook-form.com/api/useform/register'>react hook form register docs</a>
- <a href='https://www.bigscal.com/blogs/frontend/why-is-react-hook-form-better-than-other-forms/'>why is react hook form better than other forms</a>
